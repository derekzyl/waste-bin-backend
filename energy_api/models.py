...
class EnergyDevice(Base):
    ...
    cost_settings = relationship("EnergyCostSettings", back_populates="device", uselist=False)
...
class EnergySensorConfig(Base):
    ...
    __table_args__ = (UniqueConstraint('device_id', 'sensor_number', name='uix_device_sensor'),)
